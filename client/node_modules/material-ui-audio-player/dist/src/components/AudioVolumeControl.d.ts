...
export declare const useComponentStyles: (props?: any) => Record<"sliderContainer" | "icon" | "slider" | "commonContainer" | "volumeIconContainer" | "volumeControlContainer", string>;
