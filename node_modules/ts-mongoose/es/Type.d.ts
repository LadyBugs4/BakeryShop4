...
export declare const Type: {
    ...
    object: <O_7 extends TypeOptions<object>>(options?: O_7 | undefined) => {
        of<T extends object>(schema: T): GetType<O_7, { [P in keyof Convert<T>]: Convert<T>[P]; }>;
    };
    ...
    schema: <O_9 extends TypeOptions<object>>(options?: O_9 | undefined) => {
        of<T_2 extends Record<"definition", any>>(schema: T_2): GetType<O_9, Extract<T_2> & GetSubDocument<T_2>>;
    };
    ref: <T_3>(schema: T_3) => {
